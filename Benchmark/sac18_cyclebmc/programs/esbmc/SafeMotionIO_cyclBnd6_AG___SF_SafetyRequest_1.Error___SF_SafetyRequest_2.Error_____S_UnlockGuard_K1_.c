// FORMULA: AG ((SF_SafetyRequest_1.Error & SF_SafetyRequest_2.Error)=> !S_UnlockGuard_K1)
// BOUND: 6
...
int main(){
	...
	loc828:
	__VERIFIER_assert((!((((!((SafeMotionIO_SF_SafetyRequest_1_Error == (0 != 0)))) && (!((SafeMotionIO_SF_SafetyRequest_2_Error == (0 != 0))))) && (!((SafeMotionIO_S_UnlockGuard_K1 == (0 != 0))))))));
