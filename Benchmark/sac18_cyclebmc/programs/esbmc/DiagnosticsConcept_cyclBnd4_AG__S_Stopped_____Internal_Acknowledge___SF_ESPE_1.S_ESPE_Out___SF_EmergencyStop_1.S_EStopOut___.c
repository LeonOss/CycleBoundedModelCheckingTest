// FORMULA: AG (S_Stopped => (Internal_Acknowledge & SF_ESPE_1.S_ESPE_Out & SF_EmergencyStop_1.S_EStopOut ))
// BOUND: 4
...
int main(){
	...
	loc448:
	__VERIFIER_assert((!(((!((DiagnosticsConcept_S_Stopped == (0 != 0)))) && (!((((!((DiagnosticsConcept_Internal_Acknowledge == (0 != 0)))) && (!((DiagnosticsConcept_SF_ESPE_1_S_ESPE_Out == (0 != 0))))) && (!((DiagnosticsConcept_SF_EmergencyStop_1_S_EStopOut == (0 != 0)))))))))));
