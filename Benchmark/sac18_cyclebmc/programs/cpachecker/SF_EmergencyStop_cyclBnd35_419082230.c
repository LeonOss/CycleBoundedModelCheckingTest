// FORMULA: AG (DiagCode=0 | DiagCode=0x8000 | DiagCode=0x8001 | DiagCode=0x8002 | DiagCode=0x8003 | DiagCode=0x8004 | DiagCode=0x8005 | DiagCode=0xC001 | DiagCode=0xC002)
// BOUND: 35
...
int main(){
	...
	loc111:
	__VERIFIER_assert((!((((((((((!((SF_EmergencyStop_DiagCode == 0))) && (!((SF_EmergencyStop_DiagCode == 32768)))) && (!((SF_EmergencyStop_DiagCode == 32769)))) && (!((SF_EmergencyStop_DiagCode == 32770)))) && (!((SF_EmergencyStop_DiagCode == 32771)))) && (!((SF_EmergencyStop_DiagCode == 32772)))) && (!((SF_EmergencyStop_DiagCode == 32773)))) && (!((SF_EmergencyStop_DiagCode == 49153)))) && (!((SF_EmergencyStop_DiagCode == 49154)))))));
