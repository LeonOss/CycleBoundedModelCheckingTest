// FORMULA: AG (SF_EnableSwitch_1.DiagCode > 0xC000 => SF_EmergencyStop_1.Error)
// BOUND: 6
...
int main(){
	...
	loc828:
	__VERIFIER_assert((!(((SafeMotionIO_SF_EnableSwitch_1_DiagCode > 49152) && (SafeMotionIO_SF_EmergencyStop_1_Error == (0 != 0))))));
