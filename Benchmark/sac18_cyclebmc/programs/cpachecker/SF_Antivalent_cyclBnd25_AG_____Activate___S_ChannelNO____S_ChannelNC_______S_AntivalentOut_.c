// FORMULA: AG ((! Activate | S_ChannelNO | !S_ChannelNC) => ! S_AntivalentOut)
// BOUND: 25
...
int main(){
	...
	loc101:
	__VERIFIER_assert((!(((!((((!((SF_Antivalent_Activate == (0 != 0)))) && (SF_Antivalent_S_ChannelNO == (0 != 0))) && (!((SF_Antivalent_S_ChannelNC == (0 != 0))))))) && (!((SF_Antivalent_S_AntivalentOut == (0 != 0))))))));
