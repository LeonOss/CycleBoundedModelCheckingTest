// FORMULA: AG (DiagCode=0x8011 => MutingEnable & !MutingSwitch12 & !MutingSwitch21)
// BOUND: 15
...
int main(){
	...
	loc208:
	__VERIFIER_assert((!(((SF_MutingSeq_DiagCode == 32785) && (!((((!((SF_MutingSeq_MutingEnable == (0 != 0)))) && (SF_MutingSeq_MutingSwitch12 == (0 != 0))) && (SF_MutingSeq_MutingSwitch21 == (0 != 0)))))))));
