// FORMULA: AG (!S2_S_ESPE_In => !(SF_ESPE_1.DiagCode = 0x8004) | !(SF_ESPE_1.DiagCode = 0x8001))
// BOUND: 20
...
int main(){
	...
	loc448:
	__VERIFIER_assert((!(((DiagnosticsConcept_S2_S_ESPE_In == (0 != 0)) && ((DiagnosticsConcept_SF_ESPE_1_DiagCode == 32772) && (DiagnosticsConcept_SF_ESPE_1_DiagCode == 32769))))));
