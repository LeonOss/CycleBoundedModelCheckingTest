// FORMULA: AG (!Activate => (!Ready & !S_AntivalentOut & DiagCode=0 & !Error)) 
// BOUND: 30
...
int main(){
	...
	loc101:
	__VERIFIER_assert((!(((SF_Antivalent_Activate == (0 != 0)) && (!(((((SF_Antivalent_Ready == (0 != 0)) && (SF_Antivalent_S_AntivalentOut == (0 != 0))) && (SF_Antivalent_DiagCode == 0)) && (SF_Antivalent_Error == (0 != 0)))))))));
