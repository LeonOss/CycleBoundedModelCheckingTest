// FORMULA: EF (S_SafeMotionActive & S_SetupMode & S_Enable_M1)
// BOUND: 6
...
int main(){
	...
	loc828:
	__VERIFIER_assert((!((((!((SafeMotionIO_S_SafeMotionActive == (0 != 0)))) && (!((SafeMotionIO_S_SetupMode == (0 != 0))))) && (!((SafeMotionIO_S_Enable_M1 == (0 != 0))))))));
