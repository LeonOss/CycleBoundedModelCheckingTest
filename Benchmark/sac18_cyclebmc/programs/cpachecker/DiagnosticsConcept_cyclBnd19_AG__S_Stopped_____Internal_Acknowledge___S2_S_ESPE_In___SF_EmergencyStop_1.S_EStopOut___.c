// FORMULA: AG (S_Stopped => (Internal_Acknowledge | S2_S_ESPE_In & SF_EmergencyStop_1.S_EStopOut ))
// BOUND: 19
...
int main(){
	...
	loc448:
	__VERIFIER_assert((!(((!((DiagnosticsConcept_S_Stopped == (0 != 0)))) && ((DiagnosticsConcept_Internal_Acknowledge == (0 != 0)) && (!(((!((DiagnosticsConcept_S2_S_ESPE_In == (0 != 0)))) && (!((DiagnosticsConcept_SF_EmergencyStop_1_S_EStopOut == (0 != 0))))))))))));
