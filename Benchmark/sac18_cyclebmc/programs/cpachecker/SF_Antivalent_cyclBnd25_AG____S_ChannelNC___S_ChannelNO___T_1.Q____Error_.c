// FORMULA: AG ((!S_ChannelNC & S_ChannelNO & T_1.Q)=>!Error)
// BOUND: 25
...
int main(){
	...
	loc101:
	__VERIFIER_assert((!(((((SF_Antivalent_S_ChannelNC == (0 != 0)) && (!((SF_Antivalent_S_ChannelNO == (0 != 0))))) && (!((SF_Antivalent_T_1_Q == (0 != 0))))) && (!((SF_Antivalent_Error == (0 != 0))))))));
